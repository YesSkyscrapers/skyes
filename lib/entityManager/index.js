    ...
    function EntityManager() {
        ...
        this.read = function (entityClass, pagination, filters) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var repository, result, _a, whereObject, orderObject, _b;
                var _c;
        ...
        this.create = function (entityClass, entity) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        result = (_a.entity = _c.sent(),
                            _a.count = -1 //await repository!.count()
                        ,
                            _a);
                        return [2 /*return*/, result];
                }
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            this.checkConnection();
                            repository = (_a = this.connection) === null || _a === void 0 ? void 0 : _a.getRepository(entityClass);
                            result = {
                                count: -1
                            };
                            return [4 /*yield*/, repository.remove(entities)
                                // result.count = await repository!.count()
                            ];
                        case 1:
                            _b.sent();
