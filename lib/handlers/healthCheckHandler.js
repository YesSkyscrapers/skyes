...
var handler = function (config) { return function (params) { return __awaiter(void 0, void 0, void 0, function () {
    var httpRequest, request, httpResponse, response, handlerParams, headers_1, error;
