...
var handler = function (config, dispose) { return function (params) { return __awaiter(void 0, void 0, void 0, function () {
    var httpRequest, request, httpResponse, response, handlerParams, headers_1, _error_1, error;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                _error_1 = _a.sent();
                error = "DisposeHandler error: ".concat(_error_1);
                throw error;
