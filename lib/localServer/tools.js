...
exports.getRequestInfo = exports.checkUrlPatterns = exports.getRequestObject = exports.createResponseObject = void 0;
...
var uniqueId = 0;
var createResponseObject = function (url) {
    return new Promise(function (resolve, reject) {
        var config = server_1.default.getConfig();
        var headers = [];
        headers.push({
            key: 'Content-Type',
...
var checkUrlPatterns = function (handlerUrl, requestUrl) {
    var config = server_1.default.getConfig();
